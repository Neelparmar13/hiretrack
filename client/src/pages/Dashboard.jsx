...
export default function Dashboard() {
  ...
  const handleAdded   = (newJob)     => setJobs((prev) => [newJob, ...prev]);
  const handleUpdated = (updatedJob) => setJobs((prev) => prev.map((j) => j._id === updatedJob._id ? updatedJob : j));
    ...
    <div style={{ minHeight: "100vh", background: "#f7f8fa" }}>
        ...
        <div style={toolbar}>
          <div style={{ display: "flex", gap: 8, flexWrap: "wrap", alignItems: "center" }}>
              ...
              {STATUSES.map((s) => (
                <button
                  ...
                  style={{
                    ...
                    background: filterStatus === s ? "#185FA5" : "#fff",
            ...
            <select
              ...
              style={{ fontSize: 13, padding: "5px 10px", borderRadius: 8, border: "0.5px solid #ddd" }}
            >
      ...
      <div style={{ padding: "16px 24px 40px" }}>
        {loading ? (
          ...
          <KanbanBoard jobs={filteredJobs} setJobs={setJobs} onUpdated={handleUpdated} />
        )}
      </div>
